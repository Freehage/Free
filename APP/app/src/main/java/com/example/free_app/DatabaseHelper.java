...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static String databaseName = "user_table.db"; // 데이터베이스 이름
    private static String tableName = "item_data"; // 테이블 이름
        ...
        try{
            ...
            if (mCursor != null){
                ...
                while(mCursor.moveToNext()){
                    ...
                    // 해당 Row 저장
                    User market = new User();

                    market.setId(mCursor.getInt(0));
                    market.setName(mCursor.getString(1));
                    market.setCategory(mCursor.getString(2));
                    market.setLevel(mCursor.getInt(3));
                    market.setAmount(mCursor.getInt(4));
                    market.setEnd_date(mCursor.getString(5));
